...
public class CondIsStaff extends Condition {
    ...
    static{
        Skript.registerCondition(CondIsMod.class,
                "%string% (is|are) [a] [channel] staff for %string%",
                "%string% (is|are)( not|n't) [a] [channel] staff for %string%"
        );
    }
