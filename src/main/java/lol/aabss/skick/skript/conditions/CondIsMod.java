...
public class CondIsMod extends Condition {
    ...
    static{
        Skript.registerCondition(CondIsMod.class,
                "%string% (is|are) [a] [channel] mod[erator] for %string%",
                "%string% (is|are)( not|n't) [a] [channel] mod[erator] for %string%"
        );
    }
