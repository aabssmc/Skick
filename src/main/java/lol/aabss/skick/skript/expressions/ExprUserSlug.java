...
public class ExprUserSlug extends SimpleExpression<String> {

    Expression<String> user;
    Expression<String> channel;

    static{
        Skript.registerExpression(ExprUserSlug.class, String.class, ExpressionType.COMBINED,
                "[the] slug of [user] %string% from [channel] %string%",
                "[user] %string%'s slug from [channel] %string%"
        );
    }
    ...
    protected @Nullable String[] get(@NotNull Event e) {
        return new String[]{client.chatrooms.cache.getChatter(channel.getSingle(e), user.getSingle(e)).getSlug()};
    }
