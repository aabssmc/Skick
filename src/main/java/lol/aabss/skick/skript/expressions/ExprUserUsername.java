...
public class ExprUserUsername extends SimpleExpression<String> {

    Expression<String> user;
    Expression<String> channel;

    static{
        Skript.registerExpression(ExprUserUsername.class, String.class, ExpressionType.COMBINED,
                "[the] username of [user] %string% from [channel] %string%",
                "[user] %string%'s username from [channel] %string%"
        );
    }
    ...
    protected @Nullable String[] get(@NotNull Event e) {
        return new String[]{client.chatrooms.cache.getChatter(channel.getSingle(e), user.getSingle(e)).getUsername()};
    }
